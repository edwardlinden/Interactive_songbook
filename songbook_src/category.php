...
<head>
  ...
  <title>Songbook - Punch Songs</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Punch Songs</h1>
          <p class="mb-4">Here is Punch songs displayed. You are able to search for anything you want, as much as it
            contains Punch songs.</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Punch Songs</h6>
            </div>
            <div class="card-body">
